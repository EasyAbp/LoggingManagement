...
using LoggingManagementSample.Web;
...
namespace LoggingManagementSample
{
    [DependsOn(
        ...
        typeof(LoggingManagementSampleWebModule),
        typeof(LoggingManagementSampleApplicationTestModule)
    )]
    public class LoggingManagementSampleWebTestModule : AbpModule
    {
        ...
        private static void ConfigureLocalizationServices(IServiceCollection services)
        {
            ...
            {
                options.Resources
                    .Get<LoggingManagementSampleResource>()
                    .AddBaseTypes(
