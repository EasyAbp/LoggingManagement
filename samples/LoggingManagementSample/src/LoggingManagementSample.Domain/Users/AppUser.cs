...
namespace LoggingManagementSample.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update LoggingManagementSampleDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update LoggingManagementSampleEfCoreEntityExtensionMappings to extend the IdentityUser entity
