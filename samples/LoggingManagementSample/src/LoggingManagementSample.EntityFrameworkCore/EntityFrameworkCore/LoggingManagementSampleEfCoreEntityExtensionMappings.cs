...
{
    public static class LoggingManagementSampleEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE LoggingManagementSampleModuleExtensionConfigurator CLASS (in the Domain.Shared project)
